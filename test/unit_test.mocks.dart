...
// in etiqa_demo/test/unit_test.dart.
...
import 'package:etiqa_demo/database/todo_db.dart' as _i3;
...
class _FakeTodoItem_3 extends _i1.SmartFake implements _i3.TodoItem {
  _FakeTodoItem_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
/// A class which mocks [TodoBox].
///
/// See the documentation for Mockito's code generation for more information.
class MockTodoBox extends _i1.Mock implements _i3.TodoBox {
  MockTodoBox() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i4.Future<_i2.Box<dynamic>> openTodoBox() => (super.noSuchMethod(
        Invocation.method(
          #openTodoBox,
          [],
        ),
  ...
  @override
  _i4.Future<int> addNewItem(_i3.TodoItem? todoItem) => (super.noSuchMethod(
        Invocation.method(
          #addNewItem,
          [todoItem],
        ),
  ...
  @override
  _i4.Future<List<_i3.TodoItem>> getAllItems() => (super.noSuchMethod(
        Invocation.method(
          #getAllItems,
          [],
        ),
        returnValue: _i4.Future<List<_i3.TodoItem>>.value(<_i3.TodoItem>[]),
      ) as _i4.Future<List<_i3.TodoItem>>);

  @override
  _i4.Future<_i3.TodoItem> getItem(int? key) => (super.noSuchMethod(
        Invocation.method(
          #getItem,
          [key],
        ),
        returnValue: _i4.Future<_i3.TodoItem>.value(_FakeTodoItem_3(
          this,
          Invocation.method(
            #getItem,
            [key],
  ...
  @override
  _i4.Future<void> deleteItem(int? key) => (super.noSuchMethod(
        Invocation.method(
          #deleteItem,
          [key],
        ),
  ...
  @override
  _i4.Future<int> clearBox() => (super.noSuchMethod(
        Invocation.method(
          #clearBox,
          [],
        ),
